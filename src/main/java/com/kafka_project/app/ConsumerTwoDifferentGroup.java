...
public class ConsumerTwoDifferentGroup {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            writer = new BufferedWriter(new FileWriter("Resultat/ResultatCosummerTwoDifferentGroup.txt"));
        } catch (IOException e) {
            e.printStackTrace();
       ...
       // Créer deux consommateurs avec des propriétés différentes
    ...
    while (running.get()) {
            ...
            if (records.isEmpty()) {
                ...
                for (ConsumerRecord<String, String> record : records) {
                    buffer.add(record);
                    consumedCount++; // Compter les messages consommés
                }
            ...
            // Afficher combien de messages ont été consommés
